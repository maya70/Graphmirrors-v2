			...
			return this;},
		{
			...
			afterAdded: function(parent) {
				...
				if (!this.svg) {
					...
					this.displayHints();}},
			updateJSON: function(){
				if(this.svg) this.svg.updateJSON(); 
				else console.log('Cannot find TreeRing data!');
			},
			/**
			...
			createSvg: function(config, suppressPropogate) {
				...
				actual_config.filename = this._file; 
				actual_config.dataTree = this.dataTree; 
